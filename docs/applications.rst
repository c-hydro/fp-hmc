...
In the gridded outcome files, the default configuration of outcome variables are reported below:
    - Dicharge: Discharge [m^3/s]
    - Daily Accumulated Evapotranspiration: ETCum [mm]
    - Sensible Heat: H [W/m^2] (H)
...
* Time Series
    ...
    "Point"		  : {
      "FileName"    : "hmc.$VAR.$yyyy$mm$dd$HH$MM.txt",
      "FilePath"	: "/home/fabio/Desktop/PyCharm_Workspace/hmc-ws/run/$RUN/data/outcome/$MODE/point/$yyyy/$mm/$dd/",
      "FileType"	: 1,
      "FileTimeRes" : 3600,
      "FileVars"	: {
        "ARCHIVE"	  : {
          ...
          "VarName"           : {
            "Discharge"	        : {
              ...
              "FilePath"          : "/home/fabio/Desktop/PyCharm_Workspace/hmc-ws/data/archive/$RUN/$yyyy/$mm/$dd/$HH/outcome/point/$MODE/discharge/",
              "FileVar"		      : "discharge"
                                },
            "DamV"				: {
              "FileName"          : "hmc.vdam.$yyyy$mm$dd$HH$MM.txt",
              "FilePath"          : "/home/fabio/Desktop/PyCharm_Workspace/hmc-ws/data/archive/$RUN/$yyyy/$mm/$dd/$HH/outcome/point/$MODE/dam_volume/",
              "FileVar"		      : "vdam"
                                },
            "DamL"				: {
              "FileName"          : "hmc.ldam.$yyyy$mm$dd$HH$MM.txt",
              "FilePath"          : "/home/fabio/Desktop/PyCharm_Workspace/hmc-ws/data/archive/$RUN/$yyyy/$mm/$dd/$HH/outcome/point/$MODE/dam_level/",
              "FileVar"		      : "ldam"
                                },
            "VarAnalysis"		: {
              "FileName"          : "hmc.var-analysis.$yyyy$mm$dd$HH$MM.txt",
              "FilePath"          : "/home/fabio/Desktop/PyCharm_Workspace/hmc-ws/data/archive/$RUN/$yyyy/$mm/$dd/$HH/outcome/point/$MODE/analysis/",
    ...
    "TimeSeries"  : {
      ...
      "FilePath"    : "/home/fabio/Desktop/PyCharm_Workspace/hmc-ws/run/$RUN/data/outcome/$MODE/timeseries/",
      "FileType"	: 1,
      "FileTimeRes"	: 3600,
      "FileVars"	: {
        "ARCHIVE"	  : {
          ...
          "VarName"           : {
            "Discharge"			: {
              ...
              "FilePath"          : "/home/fabio/Desktop/PyCharm_Workspace/hmc-ws/data/archive/$RUN/$yyyy/$mm/$dd/$HH/outcome/timeseries/$MODE/",
              "FileVar"		      : "hydrograph"
                                },
            "DamV"				: {
        ...
        "HYDRAPP"		: {
          ...
          "VarName"           : {
            "Discharge"			: {
              ...
              "FilePath"          : "/home/fabio/Desktop/PyCharm_Workspace/hmc-ws/data/archive/$RUN/$yyyy/$mm/$dd/$HH/outcome/dewetra/$MODE/",
              "FileVar"		      : "hydrograph"
                                }
                              }
                        }
