...
python hmc_tool_processing_json2dew_converter.py -settings_file configuration.json -time "YYYY-MM-DD HH:MM"

Version:
20210730 (2.0.2) --> Add dam case and update algorithm options
...
from tools.processing_tool_json2dew_converter.lib_utils_logging import set_logging_file
from tools.processing_tool_json2dew_converter.lib_utils_time import set_time
from tools.processing_tool_json2dew_converter.lib_data_io_json import read_file_settings
from tools.processing_tool_json2dew_converter.lib_info_args import logger_name, time_format_algorithm

from tools.processing_tool_json2dew_converter.driver_data_io_static import DriverStatic
from tools.processing_tool_json2dew_converter.driver_data_io_dynamic import DriverDynamic
# -------------------------------------------------------------------------------------
