...
def define_logging_file(logger_obj,
                        tag_folder_name='folder_name', tag_file_name='file_name'):

    folder_name, file_name = None, None
    if tag_folder_name in list(logger_obj.keys()):
        folder_name = logger_obj[tag_folder_name]
    if tag_file_name in list(logger_obj.keys()):
        file_name = logger_obj[tag_file_name]
