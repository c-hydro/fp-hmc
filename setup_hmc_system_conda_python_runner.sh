...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HMC ENVIRONMENT - PYTHON3 LIBRARIES FOR PACKAGE - RUNNER TOOLS TYPE - CONDA'
script_version="1.6.5"
script_date='2024/02/15'
...
if [ -f $fp_env_file_requirements ] ; then
	...
	conda create --yes --name $fp_env_folder_libraries numpy scipy matplotlib==3.1.3 gdal h5py cartopy==0.17 pandas geopandas rasterio netCDF4 cython xarray bottleneck dask pip python=3.7
