...
class ModelArgs:
    ...
    def __init__(self, file_algorithm, file_datasets, time,
        ...
        if 'dset_datetime_run' not in list(self.obj_template_time_ref.keys()):
            ...
            log_stream.warning(' ===> Variable "dset_datetime_run" is set to default value ("%Y%m%d%H%M").')
        ...
        if 'dset_sub_path_run' not in list(self.obj_template_time_ref.keys()):
            ...
            log_stream.warning(' ===> Variable "dset_sub_path_run" is set to default value ("%Y/%m/%d/%H00").')
