...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HMC RUNNER - NWP WRF - HISTORY'
...
setting_file_hmc='/share/c-hydro/hmc-master/config/algorithms/hmc_model_run-manager_algorithm_nwp_wrf_history.config'

env_flag=false

folder_lock_raw='/share/c-hydro/lock/'
file_lock_start_raw='hmc_runner_nwp_wrf_lock_%YYYY%MM%DD%HH00_history_START.txt'
file_lock_end_raw='hmc_runner_nwp_wrf_lock_%YYYY%MM%DD%HH00_history_END.txt'
